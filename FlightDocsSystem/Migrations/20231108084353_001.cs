        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    doc_title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    doc_type_id = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    flight_no = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    create_by = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    create_date = table.Column<DateTime>(type: "datetime", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "50456553-6b3f-4cb0-a2a6-3f4a84c67336", "Admin", "ADMIN" },
                    { "2", "90bf447d-03b8-4ab3-98ba-ef743d817240", "User", "USER" }
                });
